...
#endif
l9_0=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_1,((varPackedTex.xy-Port_Center_N010)*vec2(uvScale))+Port_Center_N010,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
}
#else
{
...
#endif
l9_3=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_4,((varPackedTex.xy-Port_Center_N010)*vec2(uvScale))+Port_Center_N010,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex).x;
}
#else
{
l9_3=Port_Default_N029;
}
#endif
float l9_5=l9_2.w*l9_3;
