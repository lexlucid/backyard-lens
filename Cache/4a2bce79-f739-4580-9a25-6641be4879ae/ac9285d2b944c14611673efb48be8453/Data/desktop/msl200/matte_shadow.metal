...
//ubo int UserUniforms 2:33:4112 {
...
//float4 opacityTexSize 3824
//float4 opacityTexDims 3840
//float4 opacityTexView 3856
//float3x3 opacityTexTransform 3872
//float4 opacityTexUvMinMax 3920
//float4 opacityTexBorderColor 3936
//float2 Tweak_N14 3952
//float2 Tweak_N15 3960
//float2 Tweak_N50 3968
//float2 Tweak_N51 3976
//float3 Port_Input0_N006 3984
//float Port_Import_N201 4000
//float Port_Import_N023 4004
//float Port_Import_N010 4008
//float Port_Import_N009 4012
//float2 Port_Import_N011 4016
//float2 Port_Import_N012 4024
//float Port_Speed_N022 4032
//float2 Port_Import_N254 4040
//float Port_Import_N065 4048
//float Port_Import_N055 4052
//float Port_Import_N056 4056
//float2 Port_Import_N026 4064
//float2 Port_Import_N060 4072
//float2 Port_Import_N061 4080
//float Port_Speed_N063 4088
//float2 Port_Import_N255 4096
//float Port_Value2_N001 4104
//float depthRef 4108
//}
...
//spec_const int NODE_13_DROPLIST_ITEM 1074
//spec_const int NODE_27_DROPLIST_ITEM 1075
//spec_const int NODE_49_DROPLIST_ITEM 1076
...
float2 l9_69=(*sc_set2.UserUniforms).Tweak_N15;
l9_68=l9_69;
...
l9_72=l9_71+(l9_70*(l9_52.gTimeElapsed*(*sc_set2.UserUniforms).Port_Speed_N022));
l9_50=l9_72;
l9_53=l9_50;
}
else
...
float2 l9_85=(*sc_set2.UserUniforms).Tweak_N14;
l9_84=l9_85;
float2 l9_86=float2(0.0);
l9_86=l9_84;
float2 l9_87=float2(0.0);
float2 l9_88=(*sc_set2.UserUniforms).Tweak_N15;
l9_87=l9_88;
...
float2 l9_140=(*sc_set2.UserUniforms).Tweak_N15;
l9_139=l9_140;
...
l9_143=l9_142+(l9_141*(l9_123.gTimeElapsed*(*sc_set2.UserUniforms).Port_Speed_N022));
l9_121=l9_143;
l9_124=l9_121;
}
else
...
float2 l9_156=(*sc_set2.UserUniforms).Tweak_N14;
l9_155=l9_156;
float2 l9_157=float2(0.0);
l9_157=l9_155;
float2 l9_158=float2(0.0);
float2 l9_159=(*sc_set2.UserUniforms).Tweak_N15;
l9_158=l9_159;
...
float2 l9_167=(*sc_set2.UserUniforms).Tweak_N50;
l9_166=l9_167;
float2 l9_168=float2(0.0);
l9_168=l9_166;
float2 l9_169=float2(0.0);
float2 l9_170=(*sc_set2.UserUniforms).Tweak_N51;
l9_169=l9_170;
...
l9_173=l9_172+(l9_171*(l9_102.gTimeElapsed*(*sc_set2.UserUniforms).Port_Speed_N063));
l9_100=l9_173;
l9_103=l9_100;
}
else
...
float2 l9_207=(*sc_set2.UserUniforms).Tweak_N14;
l9_206=l9_207;
float2 l9_208=float2(0.0);
l9_208=l9_206;
float2 l9_209=float2(0.0);
float2 l9_210=(*sc_set2.UserUniforms).Tweak_N15;
l9_209=l9_210;
...
l9_213=l9_212+(l9_211*(l9_193.gTimeElapsed*(*sc_set2.UserUniforms).Port_Speed_N022));
l9_191=l9_213;
l9_194=l9_191;
}
else
...
float2 l9_226=(*sc_set2.UserUniforms).Tweak_N14;
l9_225=l9_226;
float2 l9_227=float2(0.0);
l9_227=l9_225;
float2 l9_228=float2(0.0);
float2 l9_229=(*sc_set2.UserUniforms).Tweak_N15;
l9_228=l9_229;
...
float2 l9_237=(*sc_set2.UserUniforms).Tweak_N50;
l9_236=l9_237;
float2 l9_238=float2(0.0);
l9_238=l9_236;
float2 l9_239=float2(0.0);
float2 l9_240=(*sc_set2.UserUniforms).Tweak_N51;
l9_239=l9_240;
...
int l9_253=l9_248;
int l9_254=opacityTexLayout_tmp;
int l9_255=l9_253;
float2 l9_256=l9_34;
bool l9_257=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_258=(*sc_set2.UserUniforms).opacityTexTransform;
int2 l9_259=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_260=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_261=(*sc_set2.UserUniforms).opacityTexUvMinMax;
bool l9_262=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_263=(*sc_set2.UserUniforms).opacityTexBorderColor;
float l9_264=0.0;
...
float l9_334=l9_326;
float4 l9_335=sc_set2.opacityTex.sample(sc_set2.opacityTexSmpSC,l9_333,bias(l9_334));
float4 l9_336=l9_335;
float4 l9_337=l9_336;
if (l9_262)
{
l9_337=mix(l9_263,l9_337,float4(l9_266));
}
...
l9_341=mix((*sc_set2.UserUniforms).Port_Input0_N006,l9_24,float3(l9_340));
param=l9_341;
param_2=param;
}
else
...
if ((int(sc_ProjectiveShadowsReceiver_tmp)!=0))
{
float2 l9_345=abs(in.varShadowTex-float2(0.5));
float l9_346=fast::max(l9_345.x,l9_345.y);
float l9_347=step(l9_346,0.5);
float4 l9_348=sc_set2.sc_ShadowTexture.sample(sc_set2.sc_ShadowTextureSmpSC,in.varShadowTex)*l9_347;
float3 l9_349=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_348.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float l9_350=l9_348.w*(*sc_set2.UserUniforms).sc_ShadowDensity;
l9_344=mix(float3(1.0),l9_349,float3(l9_350));
}
else
{
l9_344=float3(1.0);
}
float3 l9_351=l9_344;
l9_343=l9_351;
}
else
{
...
float2 l9_353=floor(mod(l9_352.xy,float2(4.0)));
float l9_354=(mod(dot(l9_353,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_4<l9_354)
{
discard_fragment();
}
}
bool l9_355=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_355)
{
...
float4 l9_356=fast::max(param_5,float4(0.0));
float4 param_6=l9_356;
...
{
l9_359=fast::clamp(l9_358.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_359=fast::clamp(dot(l9_358.xyz,float3(l9_358.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_359=(1.0-dot(l9_358.xyz,float3(0.33333001)))*l9_358.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_359=(1.0-fast::clamp(dot(l9_358.xyz,float3(1.0)),0.0,1.0))*l9_358.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_359=fast::clamp(dot(l9_358.xyz,float3(1.0)),0.0,1.0)*l9_358.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_359=fast::clamp(dot(l9_358.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_359=dot(l9_358.xyz,float3(0.33333001))*l9_358.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_359=1.0-fast::clamp(dot(l9_358.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_360=l9_359;
float l9_361=l9_360;
float l9_362=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_361;
float3 l9_363=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_357.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_364=float4(l9_363.x,l9_363.y,l9_363.z,l9_362);
param_7=l9_364;
}
else
{
...
{
float4 l9_365=param_7;
float4 l9_366=float4(0.0);
float4 l9_367=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_368=out.FragColor0;
float4 l9_369=l9_368;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_369.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_371=gl_FragCoord;
float2 l9_372=(l9_371.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_377=l9_376;
int l9_378=l9_377;
float3 l9_379=float3(l9_373,0.0);
int l9_380=l9_375;
int l9_381=l9_378;
if (l9_380==1)
{
l9_379.y=((2.0*l9_379.y)+float(l9_381))-1.0;
}
float2 l9_382=l9_379.xy;
l9_374=l9_382;
}
else
{
...
int l9_399=sc_ScreenTextureLayout_tmp;
int l9_400=l9_395;
float l9_401=l9_396;
...
float l9_409=l9_401;
float4 l9_410=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_408,bias(l9_409));
float4 l9_411=l9_410;
l9_397=l9_411;
float4 l9_412=l9_397;
float4 l9_413=l9_412;
float4 l9_414=l9_413;
l9_367=l9_414;
}
float4 l9_415=l9_367;
float4 l9_416=l9_415;
float3 l9_417=l9_416.xyz;
float3 l9_418=l9_417;
float3 l9_419=l9_365.xyz;
float3 l9_420=definedBlend(l9_418,l9_419,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_366=float4(l9_420.x,l9_420.y,l9_420.z,l9_366.w);
float3 l9_421=mix(l9_417,l9_366.xyz,float3(l9_365.w));
l9_366=float4(l9_421.x,l9_421.y,l9_421.z,l9_366.w);
l9_366.w=1.0;
float4 l9_422=l9_366;
param_7=l9_422;
}
else
{
...
{
l9_428=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_428=float4(0.0);
